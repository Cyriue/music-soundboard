...
function setup() {
  ...
  vine_boom = loadSound('vine_boom.wav');
  ...
  blurk1 = loadSound('blurk1.wav');
  blurk2 = loadSound('blurk2.wav');
  blurk3 = loadSound('blurk3.wav');

  let b1 = new Button(width/3, height/3, 200, 80, color(226, 132, 19), color(244, 190, 124), blurk1);
  let b2 = new Button(width/2, height/3, 200, 80, color(0, 159, 183), color(153, 241, 255), blurk2);
  let b3 = new Button(2*width/3, height/3, 200, 80, color(145, 145, 233), color(204, 204, 245), blurk3);
